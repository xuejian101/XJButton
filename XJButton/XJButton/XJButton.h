...
typedef NS_ENUM(NSInteger, XJImageButtonType){
    
    /**
     *  按钮图片居左 文案居右 可以影响父布局的大小
     */
    XJImageButtonTypeLeft = 0,
    
    /**
     *  按钮图片居右 文案居左 可以影响父布局的大小
     */
    XJImageButtonTypeRight,
    
    /**
     *  按钮图片居上 文案居下 可以影响父布局的大小
     */
    XJImageButtonTypeTop,
    
    /**
     *  按钮图片居下 文案居上 可以影响父布局的大小
     */
    XJImageButtonTypeBottom,
};

typedef NS_ENUM(NSInteger,XJButtonState) {
    /**
     *  按钮状态 正常
     */
    XJButtonStateNormal = 0,
    
    /**
     *  按钮状态 高亮
     */
    XJButtonStateHighLight,
    /**
     *  按钮状态 选中
     */
    XJButtonStateSelected,
    
    /**
     *  按钮状态 不可用
     */
    XJButtonStateDisable,
};

/**
 *  默认间距
 */
static CGFloat const XJImageButtonDefaultMargin = 8;

/**
 *  默认未设置间距 自适应距离
 */
static CGFloat const XJImageButtonDefaultUnSetMargin = -1001;

typedef void(^ActionBlock)(id sender);

@interface XJButton : UIControl
/**
 *  文本
 */
 ...
 *  当前按钮状态
 */
@property (nonatomic,assign,readonly) XJButtonState currentState;
 ...
 */
- (instancetype)initWithType:(XJImageButtonType)type
